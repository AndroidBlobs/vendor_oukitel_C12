...
CUSTOM_MODEM = c710_g4_w1258_hspa
...
# LCM
BOOT_LOGO = c710_oq_c12_80_o1_hd480X996
...
# Camera
CUSTOM_HAL_IMGSENSOR = gc2365_mipi_raw gc23650_mipi_raw ov5670_mipi_raw ov8865_mipi_raw gc5025_mipi_raw gc50250_mipi_raw gc8024_mipi_raw gc23850_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = gc2365_mipi_raw ov8865_mipi_raw gc5025_mipi_raw gc8024_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_IMGSENSOR = gc23650_mipi_raw ov5670_mipi_raw gc50250_mipi_raw gc23850_mipi_raw
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN2_IMGSENSOR =

CUSTOM_KERNEL_IMGSENSOR = gc2365_mipi_raw gc23650_mipi_raw ov5670_mipi_raw ov8865_mipi_raw gc5025_mipi_raw gc50250_mipi_raw gc8024_mipi_raw gc23850_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc2365_mipi_raw ov8865_mipi_raw gc5025_mipi_raw gc8024_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_IMGSENSOR = gc23650_mipi_raw ov5670_mipi_raw gc50250_mipi_raw gc23850_mipi_raw
...
#hd480X996
BOOT_LOGO7 = c710_oq_c12_80_o1_eea_hd480X996
BASE_LOGO7 = hd480X996
...
WTK_BUILD_VERNO = OUKITEL_C12_EEA_V3.0_20190401
WTK_INTERNAL_BUILD_VERNO = C710_OQ_C12_80_O1_EEA_V0.0.6_S190401

#add CQYJ-8 jinhui.li 20180711(start)
WTK_BUILD_DATE = yes
WTK_BASEBAND_VERSION = OUKITEL_C12_20180911
WTK_KERNEL_VERSION = OUKITEL_info@oukitel.com_20180911
#add CQYJ-8 jinhui.li 20180711(end)
#add by gaoshan 20180108 start
WTK_FINGERPRINT_HARDWARE_SUPPORT = yes
FINGERPRINT_MICROARRAY_TRUSTKERNEL_A118_TEE = yes
FINGERPRINT_HAL_CUSTOM = yes
#FINGERPRINT_MICROARRAY_E064N_REE = yes
...
# A: Bug_id:add WtkFileManager chenchunyong 20171101 { modify for CQYL-120
WTK_FILEMANAGER_APP = no
# A: }

# A: Bug_id:add WtkFlashlight chenchunyong 20180121 {
WTK_FLASHLIGHT_SUPPORT = yes
# A: }

#add by gaoshan 20180118 start
WTK_MTP_LABEL = C12
WTK_PTP_LABEL = C12
WTK_INTERNAL_SD_LABEL = C12
#add by gaoshan 20180118 end

#add for CD ROM by gaoshan 20180121 start
MTK_BICR_SUPPORT = yes
#add for CD ROM by gaoshan 20180121 end

#add by xiangxiang.guo for TBSW-401 20180206 start
WTK_TARGET_BOARD_NAME = C710
#add by xiangxiang.guo for TBSW-401 20180206 end

#add CQYL-5 xudong.zhang 20180911(start)
CHROME_CUSTOMIZATIONS_PACKAGES = yes
#add CQYL-5 xudong.zhang 20180911(end)

#A:TLBL-20 xiangxiang.guo 20180208 {
WTK_STRESS_TEST = yes
#A:TLBL-20 }
#End For Common------------------------------------------------------------}

#add BUG_ID:TLBL-83 liuzhijun 20180315 (start)
WTK_APP_WAKE_GESTURE_SUPPORT = yes
#add BUG_ID:TLBL-83 liuzhijun 20180315 (end)
#A:TLBL-102 jinhui.li start 
#WTK_SNAPSHOT_SUPPORT = yes
#A:TLBL-102 jinhui.li end 

# A: Bug_id:add WtkCamera chenchunyong 20180911 {
GANGYUN_BOKEH_SUPPORT = yes
WTK_CAMERA_SUPPORT = yes
# A: }


#A by wuzhi.peng for faceunlock
FACE_UNLOCK_SUPPORT = true
FACE_UNLOCK_OQ_NOICON = yes
#A by wuzhi.peng for faceunlock

#A: BUG_ID:EJYW-188 sunshiwei 20180725 {
WTK_LIVE_DISPLAY_SUPPORT = yes
#A: }

# A: Smart navigation bar by chenchunyong 20180727 {
WTK_SMART_NAVIBAR_SUPPORT = yes
# A: }
#add BUG_ID:TLBL-764 xiangxiang.guo 20180418 (start)
USE_SEARCH_LAUNCHER3 = yes
WTK_EMAIL_WITHOUT_GMAIL = yes
WTK_PHOTOS_OVERRIDES_GALLERY2 =yes
WTK_GMAIL_WITHOUT_EMAIL = yes
#BUG_ID:TLBL-764 xiangxiang.guo 20180418 (end)

#add BUG_ID:CQYL-16 liuzhijun 20180929 (start)
#WTK_NEW_PSM_SUPPORT = yes
#add BUG_ID:CQYL-16 liuzhijun 20180929 (end)

#add by wuzhi.peng for liuhai 
WTK_LIUHAI_SCREEN_SUPPORT = yes
#add by wuzhi.peng for liuhai

#debuid:CQYL-175 add by chenxuanyu start
WTK_DEFAULT_MTP = yes
#debuid:CQYL-175 add by chenxuanyu end

#add by wuzhi.peng for CQYL-210 start
WTK_QRCODE_SUPPORT = yes
#add by wuzhi.peng for CQYL-210 end

#add by wangjian for EWSY-164/EWSY-128 start
CUSTOM_REMOVE_OPENWNN = yes
#add by wangjian for EWSY-164/EWSY-128 end
#add by wushanfei for gms EEA start
WTK_EEA_HOME_ANIMATION = yes
#add by wushanfei for gms EEA start
#add gang.liu smr start
PLATFORM_BASE_OS = OUKITEL/C12_EEA/C12:8.1.0/O11019/1546087792:user/release-keys
#add gang.liu smr end
